...
// This class is extremely similar to EventMentionInfo, escept for the fact it contains a triggerId field
// which represents the unique ID within the docID
public class EventMentionInfoLDC {
    String eventType;
    String docId;
    ...
    EventMentionInfoLDC(final String eventType, final String docId,
                        final Optional<Pair<Long, Long>> sentOffset, final Pair<Long, Long> triggerOffset,
                        final Multimap<String, Map<String, String>> roleInfos, final double score, final String triggerId) {
