 ...
 */
public final class PropRoleSequenceOnPath extends PairFeature {
      ...
      for (final SymbolPair idPair : idPairs) {
        for(final Symbol item : idPair.getMembers()) {
          ...
          if(!seenIds.contains(item)) {
            ...
            final ImmutableList<String> rolesSequence =
                com.bbn.necd.event.features.single.PropRoleSequenceOnPath.getInterveningRoleSequenceOnPathBetweenSourceTarget(eg);
