 ...
 */
public final class MaxSimPredicateAll extends PairFeature {
  private MaxSimPredicateAll(final String featureName,
  ...
  public static class Builder {
    ...
    public Builder extractFeatures(final ImmutableList<SymbolPair> idPairs,
      ...
      for (final SymbolPair item : idPairs) {
        ...
        if (maxSim > 0) {
          ...
          final ImmutableSet<Symbol> w1Remainder = Sets.difference(words1, ImmutableSet.of(maxWord1)).immutableCopy();
          final ImmutableSet<Symbol> w2Remainder = Sets.difference(words2, ImmutableSet.of(maxWord2)).immutableCopy();
    ...
    public MaxSimPredicateAll build() {
      ...
      if(indices.size() > 0) {
        ...
        return new MaxSimPredicateAll(featureName, features.build(), featureIndices, minIndex,
            maxIndex);
      } else {
        return new MaxSimPredicateAll(featureName, features.build(), featureIndices, -1, -1);
      }
    }
