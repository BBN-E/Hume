...
def main():
    ...
    if "unknown_word_case" not in word2freq:
        word2freq["unknown_word_case"] = max(word2freq.values())+1
    if "unknown_freture_case" not in feature2freq:
        feature2freq["unknown_feature_case"] = max(feature2freq.values())+1
