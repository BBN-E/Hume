...
def single_documnet_worker(json_ld_path):
    ...
    return event_type_to_grounded_top1_cnt,event_type_to_grounded_cnt,event_type_to_grounded_cnt_causal,causal_cnt
...
if __name__ == "__main__":
    ...
    serialization_root = "/d4m/ears/expts/47925_DART_FLAT.091620/expts/hume_test.dart.082720.wm.v1/serialization"
    output_dir = "/home/hqiu/Public/wm_statistics.091720"
    ...
    with manager.Pool(multiprocessing.cpu_count()) as pool:
        ...
        for idx,i in enumerate(workers):
            ...
            i.wait()
            event_type_to_grounded_top1_cnt,event_type_to_grounded_cnt,event_type_to_grounded_cnt_causal,causal_cnt = i.get()
