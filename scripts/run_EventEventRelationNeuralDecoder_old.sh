...
ldc_model_prefix=$ldc_model_root/train_ldc-E82_20191125_13_24_55_pcnn_att-20
...
$anaconda_root/envs/$conda_env_name/bin/python ../src/postprocess_parsing.py ${strOutFilePrefix}/bag_predictions_intermediate_learnit.json ${strOutFilePrefix}/bag_predictions_learnit.json
# $pt_cpu ../src/postprocess_parsing.py ${strOutFilePrefix}/bag_predictions_intermediate_ldc.json ${strOutFilePrefix}/bag_predictions_ldc.json
